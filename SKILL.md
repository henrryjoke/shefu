---
name: 六爻结构分析 · 射覆
description: 源自中国古代"射覆"猜物游戏，基于麻衣道者《正易心法》五观体系从六爻结构中读取气态，渐进精化物品特征画像。AI是画师不是鉴定师——刻画特征，命名权交给玩家。
tags: [易学, 传统文化, 文化教育, 游戏, 卦象分析]
version: "0.5.0"
author: 谛观
license: MIT (code) / CC BY-NC-SA 4.0 (data)
safety:
  disclaimer: "本技能仅用于文化教育与娱乐。输出不构成任何类型的专业建议（包括但不限于医疗、财务、法律、投资、健康建议）。使用者自行承担决策责任。"
  scope: "interpretive_game"
  restricted_triggers: ["射覆", "起卦", "占卦", "卜问"]
---
...
| 场景 | 调用信号 | AI回应 | 启动信号 |
|------|---------|--------|---------|
| 射覆 | 「玩射覆」「射覆」「帮我猜个东西」 | 「好，我已准备好起卦。」 | 「开始」「好」「嗯」 |
| 问事 | 「起卦」「占卦」「问卦」「卜问」 | 「心里想的事清楚了吗？给出1-3个关键词，或说『开始』。」 | 说「开始」「确定」「测算」 |
...
> 1. 理解本技能的输出具有解释性和推测性
> 2. 不会基于输出做出不可逆的高风险决策
> 3. 在涉及健康、财务、法律等场景时，优先咨询专业人士
> 4. 触发词仅限于明确的占卜/射覆意图，不会在日常对话中意外激活
